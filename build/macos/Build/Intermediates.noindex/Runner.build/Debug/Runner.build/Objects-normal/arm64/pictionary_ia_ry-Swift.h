...
#ifndef PICTIONARY_IA_RY_SWIFT_H
#define PICTIONARY_IA_RY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="pictionary_ia_ry",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC16pictionary_ia_ry11AppDelegate")
...
SWIFT_CLASS("_TtC16pictionary_ia_ry17MainFlutterWindow")
